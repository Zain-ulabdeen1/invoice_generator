  ...
  return (
    <nav >
      ...
      <div className='flex items-center gap-1 '>
        {!showX &&  <Menu className='md:hidden mr-2' onClick={() => setshowX(!showX)} />}
      ...
      {/* Mobile Section */}
      {showX &&  <div className='sub_nav min-w-full min-h-36 bg-gray-50 md:hidden  top-0 bottom-0 z-10'> </div>}
